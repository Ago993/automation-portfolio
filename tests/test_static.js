...
for(const demo of ["QUOTEFLOW","REPORTFLOW","LISTINODIFF","IMPORTFLOW","RECONCILEFLOW"]) {
  assert.ok(html.includes(demo),demo+" pricing card missing");
}
...
assert.equal((html.match(/class="offer-card/g)||[]).length,5);
